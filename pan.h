...
#define PanSource	"promela/maze.pml"
...
#define _nstates1	11	/* never_win */
#define minseq1	47
#define maxseq1	56
#define _endstate1	10

#define _nstates0	48	/* Player */
#define minseq0	0
#define maxseq0	46
...
#define PPlayer	((P0 *)_this)
typedef struct P0 { /* Player */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define HAS_TRACK	0
/* hidden variable: */	uchar last_move;
